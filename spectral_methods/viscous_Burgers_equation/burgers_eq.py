...
dt = 0.001  # time step
nu = 0.5  # diffusivity
Nt = 4001  # of time steps
save = 100  # save data every 'this' number of time steps
...
fftu2 = multiply(((1.0 - nu * k**2 * dt * 0.5) * fft(u1) - (0.5 * dt * (3.0*fftu1u1x - fftu0u0x))),  1.0/ (1.0 + 0.5 * nu * k**2 * dt)) 
